...
class CloudCreditsFilter(base_filter.BaseFilter):
    ...
    def lease_node_hours(self, lease_values, start=None):
        num_hosts = 0
    ...
    def check_create(self, context, lease_values):
        ...
        node_hours = self.lease_node_hours(lease_values)
    ...
    def check_update(self, context, current_lease_values, new_lease_values):
        ...
        diff = (self.lease_node_hours(new_lease_values) -
                self.lease_node_hours(current_lease_values))
